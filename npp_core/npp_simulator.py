...
# Example usage (this code runs if you execute the file directly)
if __name__ == '__main__':
    data = [
                [10.173821944444445, 10.280511944444445],
                [9.082711388888889, 9.122314166666666, 9.154185277777778, 9.181184166666666, 9.323402777777778]
            ]
    
    # Initialize and fit the model.
    hawkes_model = NonHomogeneousHawkes(n_bins=10)
    hawkes_model.fit(data, progress=True)
    
    # Generate 5 new synthetic realizations in the observation window [T_start=5, T_end=15].
    simulated_data = hawkes_model.generate(n=5, T_start=5, T_end=15)
    
    print("\nSimulated data:")
    for i, realization in enumerate(simulated_data):
